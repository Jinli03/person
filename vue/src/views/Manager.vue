        ...
        <el-col :span="11">
          <div style="display: flex">
            ...
            <el-popover popper-style="background-color: transparent; border: none; backdrop-filter: blur(8px)">
              ...
              <template #default>
                <el-button @click="router.push('/manager/data')" style="width: 120px; height: 40px">生活</el-button>
            ...
            <el-popover  popper-style="background-color: transparent; border: none">
              ...
              <template #default>
                ...
                <el-button @click="router.push('/manager/data')" style="width: 120px; height: 40px">健身记录</el-button>
            ...
            <el-popover popper-style="background-color: transparent; border: none">
              ...
              <template #default>
                <el-button @click="router.push('/manager/data')" style="width: 120px; height: 40px">知识分享</el-button>
